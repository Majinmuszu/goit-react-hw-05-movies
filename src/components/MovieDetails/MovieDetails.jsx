...
const MovieDetails = ({ movie }) => {
  ...
  return (
    <div className={s.movieWrapper}>
      <button className={s.button} onClick={goBack}>&larr; Go back</button>
      <div>
      ...
      <div>
        ...
        <ul className={s.linkList}>
          <li className={s.listItem}>
            <Link className={s.link} to={`/movies/${id}/cast`}>Cast</Link>
          </li>
          <li className={s.listItem}>
            <Link className={s.link} to={`/movies/${id}/reviews`}>Reviews</Link>
          </li>
        </ul>
        <Outlet/>
      </div>
